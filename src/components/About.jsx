...
function About() {
     ...
     data-aos-duration="2000" data-aos-easing="linear" class="m-6 p-6 md:w-screen align-center bg-gradient-to-l from-gray-400 via-white to-gray-400 rounded-lg border-gray-100 shadow-lg shadow-gray-500/80">
     ...
     data-aos-duration="3000" className='flex relative justify-center'>
                    <Video/>
